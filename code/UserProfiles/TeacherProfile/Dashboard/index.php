...
$error = null;
$errorColor = "red";
$classrooms = $database->performQuery("SELECT * FROM classroom,teacher_classroom,classroom_frequency where classroom_frequency.class_code=classroom.class_code AND classroom_frequency.email='" . $email->get_email() . "' AND classroom.class_code=teacher_classroom.class_code and teacher_classroom.email='" . $email->get_email() . "' AND active='1' ORDER BY classroom_frequency.frequency desc;");
        ...
        <div class="small-profile row justify-content-center mb-3 ">
          <div class="profilebox col-md-4 w-100">
            <div class="row my-auto">
              ...
              <div class="col my-auto">
                <i class="bx bxs-bell notification dropbtnsmall" onclick="myFunctionsmall()">
                      ...
                      ?>
                        <a>
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="close"><span><button style="all:unset" name="clear<?php echo $notification['notification_id'] ?>"><i class='bx bx-sm bx-x '></i></button></span></div>
                          </div>
                        </a>
                      <?php
                      }
